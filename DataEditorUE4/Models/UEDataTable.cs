...
namespace DataEditorUE4.Models
{
    public class UEDataTable
    {
        ...
        public Dictionary<DataRowKey, UEDataTableObject> Rows { get; set; }
        ...
        public UEDataTable(Dictionary<DataRowKey, UEDataTableObject> rows, string name, byte[] headerBytes, byte[] footerBytes)
        {
            Rows = rows;
